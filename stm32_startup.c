...
#define SRAM_SIZE (128 * 124)	/* 128KB */
...
void USB_Wake_UP_IRQHandler			(void) __attribute__((weak, alias("Default_Handler")));
...
uint32_t vectors[]  __attribute__((section(".isr_vector"))) = {
	...
	(uint32_t)RTC_WKUP_IRQHandler,
	(uint32_t)USB_Wake_UP_IRQHandler,
...
void Reset_Handler(void){
	...
	uint8_t *pSrc = (uint8_t*)&_edata;		//ROM
